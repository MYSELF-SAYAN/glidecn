    ...
    nav: {
      title: (
        <span className="flex items-center gap-2.5 font-bold">
          <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6">
            <rect x="1" y="1" width="11" height="11" rx="3.5" fill="hsl(var(--fd-primary))" opacity="0.9" />
            <rect x="16" y="1" width="11" height="11" rx="3.5" fill="hsl(var(--fd-primary))" opacity="0.6" />
