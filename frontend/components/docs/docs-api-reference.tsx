...
const API_ITEMS: ApiItem[] = [
  ...
  // 3. Engine & Registry
  {
    ...
    signature: 'defaultRegistry.getNames() / registerTransition(def)',
    description: 'The global singleton registry for discovering installed transition names (getNames, getAll, getByCategory), inspecting metadata, and registering custom transitions.',
    highlights: ['getNames()', 'getAll()', 'getByCategory()', 'registerTransition()', 'resolveTransition()'],
    icon: Cpu,
    keywords: 'registry registerTransition resolveTransition getTransition getNames getAll getByCategory has unregister custom transitions',
  },
  {
    id: 'animation-engine',
