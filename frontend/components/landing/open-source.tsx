      ...
      <motion.div style={{ y, opacity }} className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        >
          <Link
            ...
            target="_blank"
            className="group flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-full bg-[var(--text-main)] text-[var(--bg-page)] text-sm font-bold shadow-lg transition-all duration-200 hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.97] w-full sm:w-auto"
          >
